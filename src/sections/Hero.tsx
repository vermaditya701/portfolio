...
export const Hero = () => {
  ...
  const socialIcons = [
    ...
    {
      icon: Linkedin,
      href: 'https://www.linkedin.com/in/aditya-verma-400196292/',
      label: 'LinkedIn',
    },
    {
      icon: Code2,
      href: 'https://leetcode.com/u/adityafrisky701/',
      label: 'LeetCode',
    },
  ];

  const handleViewResume = () => {
    window.open('/aditya-resume.pdf', '_blank');
  };
      ...
      <div className="relative z-10 w-full mx-auto max-w-7xl">
        ...
        >
          ...
          <motion.div className="flex flex-col justify-center order-last md:order-first" variants={itemVariants}>
            ...
            >
              Data Science student passionate about extracting meaningful insights from data using machine learning, analytics, and intelligent systems.
            ...
            >
              <p>
               With expertise in data analytics, machine learning, and predictive modeling, I turn complex datasets into actionable insights. I am passionate about building intelligent systems that solve real-world problems through data-driven innovation.
